 ...
 * @author bq
 */
public class KappaGetStatForClassDist {
...
//       
        ...
        System.out.println(
                nf.format(ReportCommonMethods.getKappaForAnnotationMap(countAllTerms, annotationMapBQ, annotationMapAK, Settings.termClasses)));
