...
public class ConvertToBIO {
    ...
    public static void main(String[] s) throws IOException, Exception {
        ...
        init();
        String fileoutput = "aclrdtec2bq.iob.txt";
        ...
        List<File> allFiles = IOMethods.getAllFilesRecursive(new File(s[0])); // e.g., the folder annotator1
        for (File f : allFiles) {
